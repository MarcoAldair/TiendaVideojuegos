<?php
	...
	if(isset($_POST['signup'])){
		...
		if($estado){
			//Desarrollador
			$actionDev = new actionDev();
			$nombre = $_POST['nombre'];
			$apellido1 = $_POST['apellido1'];
			$apellido2 = $_POST['apellido2'];
			$telefono = $_POST['telefono'];
			$dev = new developer();
			$dev->setIdDev($actionDev->getcantidadDev()+1);
			$dev->setNombre($nombre);
			$dev->setApellido1($apellido1);
			$dev->setApellido2($apellido2);
			$dev->setTelefono($telefono);
			$dev->setIdUser($user->getidUser());
